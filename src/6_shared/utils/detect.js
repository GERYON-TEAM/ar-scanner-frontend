 ...
 * @param {HTMLImageElement|HTMLVideoElement|null} source
 * @param {tf.GraphModel} model loaded YOLOv8 tensorflow.js model
 * @param {HTMLCanvasElement|null} canvasRef canvas reference
 ...
 * @param {HTMLVideoElement|null} vidSource video source
 * @param {tf.GraphModel} model loaded YOLOv8 tensorflow.js model
 * @param {HTMLCanvasElement|null} canvasRef canvas reference
 */
